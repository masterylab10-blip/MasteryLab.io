// ============================================
// MasteryLab — BSL Almost There Script
// Paste this into your BSL Almost There Spreadsheet
// ============================================

var SITE_URL = 'https://masterylab10-blip.github.io/MasteryLab.io';

var EVENT = {
    name: 'Bachata Sensual Lab — Almost There',
    date: 'TBD 2026',
...
function handleRegistration(data) {
    ...
    MailApp.sendEmail({
        ...
        subject: '📋 New BSL Almost There Registration: ' + fullName,
        htmlBody: '<h2 style="color: #8B5CF6;">New BSL Almost There Registration</h2>' +
...
function handleStripeWebhook(event) {
    ...
    for (var i = data.length - 1; i >= 1; i--) {
        ...
        if (emailInRow === customerEmail.toLowerCase() && (row[8] === 'Pending' || row[8] === '')) {
            var ticketNumber = 'ML-BSL-AT-' + new Date().toISOString().slice(0, 10).replace(/-/g, '') + '-' + Math.floor(100 + Math.random() * 900);
            ...
            MailApp.sendEmail({
                ...
                htmlBody: buildTicketEmail(attendeeName, customerEmail, ticketNumber, amountPaid, currency, 'Almost There', attendeeAddress)
            });
            found = true;
            break;
        }
