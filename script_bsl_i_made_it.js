// ============================================
// MasteryLab — BSL I Made It Script
// Paste this into your BSL I Made It Spreadsheet
// ============================================
...
function handleRegistration(data) {
    ...
    MailApp.sendEmail({
        ...
        subject: '📋 New BSL I Made It Registration: ' + fullName,
        htmlBody: '<h2 style="color: #8B5CF6;">New BSL I Made It Registration</h2>' +
...
function handleStripeWebhook(event) {
    ...
    for (var i = data.length - 1; i >= 1; i--) {
        ...
        if (emailInRow === customerEmail.toLowerCase() && (row[8] === 'Pending' || row[8] === '')) {
            var ticketNumber = 'ML-BSL-IMI-' + new Date().toISOString().slice(0, 10).replace(/-/g, '') + '-' + Math.floor(100 + Math.random() * 900);
            ...
            MailApp.sendEmail({
                ...
                htmlBody: buildTicketEmail(attendeeName, customerEmail, ticketNumber, amountPaid, currency, 'I Made It', attendeeAddress)
            });
            found = true;
            break;
        }
